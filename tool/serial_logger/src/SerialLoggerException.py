...
class ConfigException(SerialLoggerException):
    """\
...
class NotConnectedException(SerialLoggerException):
    """\
...
class MissingArgumentException(SerialLoggerException):
    """\
